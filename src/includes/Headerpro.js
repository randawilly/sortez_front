...
export default function Headerpro(props) {
...
async function logOutYes(){
  ...
  return (
        <View style={[styles.containerNopadding]}>
          <Image resizeMode={'contain'} style={styles.logo_home} source={require('../../assets/imgs/header_pro.png')} />
          ...
          <View style={[styles.btnAccountMenu]}>
            <TouchableOpacity style={[filstreStyle.w_100,filstreStyle.heighted]}></TouchableOpacity>
          </View>
          <View style={[styles.btnMaCarteMenu]}>
            <TouchableOpacity onPress={()=>goBack()} style={[filstreStyle.w_100,filstreStyle.heighted]}></TouchableOpacity>
          </View>
          {isLogged != null ?
          <View style={[stylehead.blockLoggedin,styles.row]}>
